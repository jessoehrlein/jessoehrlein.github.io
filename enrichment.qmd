...
[National Math Camps](https://nationalmathcamps.org/) is an organization that currently runs two locations of two-week summer math camps for 11-14 year olds. I spent two weeks teaching at [Camp Conway](https://nationalmathcamps.org/camp-conway/) in summer 2026.

## Dynamical Systems

Dynamical Systems focused on the behavior and applications of (mostly one-dimensional) discrete dynamical systems.

Related materials: [Blog post after camp](posts/su26-conway/)

## Algorithms

Algorithms focused on what makes something a "good" algorithm, some common sorting and graph algorithms, and their applications/extensions.
